...
johndirgrant = Grant.create(rank_level: "Direction", user_id: "16", film_id: "2", department_id: "7")

paulprodgrant = Grant.create(rank_level: "Direction", user_id: "1", film_id: "2", department_id: "7")
